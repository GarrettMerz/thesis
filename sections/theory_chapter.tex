...
In traditional quantum mechanics, quantities called operators act on the states of a system. Likewise, in a quantum field theory, quantities such as energy, momentum, and position are also treated as operators that act on the state of the vacuum. A variety of types of fields exist, but we will discuss 
