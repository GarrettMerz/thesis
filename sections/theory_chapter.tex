...
\begin{figure}[htp]
  \centering
     ...
     \end{subfigure}
  \label{fig:tHmodes}
  \caption{Feynman diagrams depicting single-top associated Higgs production modes. Because all diagrams contain initial b-quarks, all of these processes can only occur in the five-flavor PDF scheme.}  
\end{figure}
...
\begin{figure}[htp]
  \centering
     ...
     \hfill
         \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/theory_chapter/tHjb6.png}
         \caption{A 5F tHjb mode}
         \label{fig:tHjb6}
     \end{subfigure}
     \hfill
         \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/theory_chapter/tHjb7.png}
         \caption{A 5F tHjb mode}
         \label{fig:tHjb7}
     \end{subfigure}

  \label{fig:tHmodes}
  \caption{Feynman diagrams depicting single-top associated Higgs production modes. The first five diagrams can occur in the four-flavor PDF scheme, while the last two can only occur in the five-flavor PDF scheme.}  
\end{figure}
...
\begin{figure}[tbp]
        \centering
        \includegraphics[width=\linewidth]{figures/theory_chapter/STXS_acceptances.png}
