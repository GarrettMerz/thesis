...
\item Electron/muon uncertainties: energy scale, energy resolution, electron/muon ID, electron/muon isolation \ref{cite: CERN-EP-2019-145} \ref{cite: photuncs} \ref{cite: elID-CERN-EP-2018-273} \ref{cite: muuncs}
