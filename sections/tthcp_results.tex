...
\subsection{2-D Limit on $\kappa_{t}cos(\alpha), \kappa_{t}sin(\alpha)$}

\subsubsection{Constraint Using Previous Measurements}
...
\subsubsection{Constraint Using $\kappa_{t}$ Parameterization}
