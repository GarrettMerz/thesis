...
\item Photon uncertainties: energy scale and resolution (which modify the DSCB parameters as per Chapter \ref{chap:sigbkgparam}), photon ID, photon isolation \ref{cite: photuncs} \ref{cite: photuncs} \ref{cite: photuncs} \ref{cite: photuncs}
...
\begin{figure}[htbp]
  \centering
  \subfloat[Category 1: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_1_1.pdf}}
  \subfloat[Category 2: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_1_2.pdf}}
  \subfloat[Category 3: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_1_3.pdf}}\\
  \subfloat[Category 4: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_2_1.pdf}}
  \subfloat[Category 5: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_2_2.pdf}}
  \subfloat[Category 6: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_2_3.pdf}}
...
\begin{figure}[htbp]
  \centering
  \subfloat[Category 7: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_3_1.pdf}}
  \subfloat[Category 8: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_3_2.pdf}}
  \subfloat[Category 9: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_3_3.pdf}}\\
  \subfloat[Category 10: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_4_1.pdf}}
  \subfloat[Category 11: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_4_2.pdf}}
  \subfloat[Category 12: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Had_4_3.pdf}}
...
\begin{figure}[htbp]
  \centering
  \subfloat[Category 13: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Lep_1_1.pdf}}
  \subfloat[Category 14: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Lep_1_2.pdf}}\\
  \subfloat[Category 15: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Lep_2_1.pdf}}
  \subfloat[Category 16: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Lep_2_2.pdf}}
  \subfloat[Category 17: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Lep_2_3.pdf}}\\
  \subfloat[Category 18: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Lep_3_1.pdf}}
  \subfloat[Category 19: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Lep_3_2.pdf}}
  \subfloat[Category 20: $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/Lep_3_3.pdf}}\
...
\begin{figure}[htbp]
  \centering
  \subfloat[Sum of categories (unweighted): $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/hunwt.pdf}}
  \subfloat[Sum of categories (weighted): $m_{\gamma\gamma}$ (GeV)]{\includegraphics[width=0.3\textwidth]{figures/tthcp_results/invmass/hwt.pdf}}
...
\caption{Two-dimensional contour from the ATLAS Higgs coupling combination. The best fit value of $(\kappa_g,\kappa_\gamma)$ is shown with 1 and 2$\sigma$ contours. This is used as a constraint on $ggF$ and \Hgg\ in the fit. \label{fig:combkgky}}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Two-dimensional likelihood contour for $\kappa_t \cos\alpha$ and $\kappa_t \sin\alpha$, with $ggF$ and \Hgg\ constrained by the existing Higgs coupling combination result, on (a) post-fit Asimov data and (b) observed data.
...
\begin{figure}[htbp]
 ...
 $ggF$ and \Hgg\ are constrained by the previous Higgs coupling combination result.
...
\begin{figure}[htbp]
  ...
  \caption{Two-dimensional likelihood contour for $\kappa_t \cos\alpha$ and $\kappa_t \sin\alpha$, with $ggF$ and \Hgg\ parameterized as function of $\kappa_t$ and $\alpha$, on (a) post-fit Asimov data and (b) observed data.
...
\begin{figure}[htbp]
  ...
  \caption{One-dimensional likelihood scan over the CP mixing angle $\alpha$ on post-fit Asimov data (blue) and observed data (red).  $ggF$ and \Hgg\ are parameterized as functions of $\kappa_t$ and $\alpha$.
