...
\begin{figure}[htbp]
  \centering
        \subfloat[Hadronic categories]{\includegraphics[width=0.42\textwidth]{figures/categorization_xgb/had/grid_had.pdf}}
        \subfloat[Leptonic categories]{\includegraphics[width=0.42\textwidth]{figures/categorization_xgb/lep/grid_lep.pdf}}
...
\begin{figure}[htbp]
  \centering
        \subfloat[$ttH$ had]{\includegraphics[width=0.3\textwidth]{figures/preselection_and_reconstruction/ttH_had/m_score_wisc.png}}
        \subfloat[$tHjb$ had]{\includegraphics[width=0.3\textwidth]{figures/preselection_and_reconstruction/tHjb_had/m_score_wisc.png}} \\
        \subfloat[$tWH$ had]{\includegraphics[width=0.3\textwidth]{figures/preselection_and_reconstruction/tWH_had/m_score_wisc.png}}
        \subfloat[$ggF$ had]{\includegraphics[width=0.3\textwidth]{figures/preselection_and_reconstruction/ggH_had/m_score_wisc.png}}
...
\begin{figure}[htbp]
  \centering
        \subfloat[$ttH$ lep]{\includegraphics[width=0.3\textwidth]{figures/preselection_and_reconstruction/ttH_lep/m_score_wisc.png}}
        \subfloat[$tHjb$ lep]{\includegraphics[width=0.3\textwidth]{figures/preselection_and_reconstruction/tHjb_lep/m_score_wisc.png}}
        \subfloat[$tWH$ lep]{\includegraphics[width=0.3\textwidth]{figures/preselection_and_reconstruction/tWH_lep/m_score_wisc.png}}
...
\begin{figure}[htbp]
  \centering
        \subfloat[Hadronic $ttH+tHjb+tWH$]{\includegraphics[width=0.3\textwidth]{figures/categorization_xgb/had-vbls/m_score_wisc.png}}
        \subfloat[Leptonic $ttH+tHjb+tWH$]{\includegraphics[width=0.3\textwidth]{figures/categorization_xgb/lep-vbls/m_score_wisc.png}}
...
\begin{figure}[!ht] 
  \begin{center}
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/ttH/c_H_pt.pdf}
      \includegraphics[width=0.35\textwidth]{figures/observables/ttH/c_H_eta.pdf}
    }
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/ttH/c_delta_eta_tt.pdf}
      \includegraphics[width=0.35\textwidth]{figures/observables/ttH/c_delta_phi_tt.pdf}
    }
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/ttH/c_t_pt.pdf}
      \includegraphics[width=0.35\textwidth]{figures/observables/ttH/c_t_eta.pdf}
    }
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/ttH/c_tH_m.pdf}
    }
  \end{center}
...
\begin{figure}[htbp]
  \centering
  	\subfloat[Signed $\Delta\phi(t,\bar{t})$]{\includegraphics[width=0.32\textwidth]{figures/observables/ttH/c_delta_phi_tt_signed.png}}\\
	\subfloat[Signed $\Delta\phi(t,W)$]{\includegraphics[width=0.32\textwidth]{figures/observables/ttH/c_delta_phi_tW_signed.png}} 
	\subfloat[Signed $\Delta\phi(t,W)$]{\includegraphics[width=0.32\textwidth]{figures/observables/ttH/c_delta_phi_tj_signed.png}} 
...
\begin{figure}[!ht] 
  \begin{center}
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/tWH/c_H_pt.pdf}
      \includegraphics[width=0.35\textwidth]{figures/observables/tWH/c_H_eta.pdf}
    }
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/tWH/c_t_pt.pdf}
      \includegraphics[width=0.35\textwidth]{figures/observables/tWH/c_t_eta.pdf}
    }
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/tWH/c_tH_m.pdf}
    }
  \end{center}
...
\begin{figure}[!ht] 
  \begin{center}
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/tHjb/c_H_pt.pdf}
      \includegraphics[width=0.35\textwidth]{figures/observables/tHjb/c_H_eta.pdf}
    }
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/tHjb/c_t_pt.pdf}
      \includegraphics[width=0.35\textwidth]{figures/observables/tHjb/c_t_eta.pdf}
    }
    \mbox{ 
      \includegraphics[width=0.35\textwidth]{figures/observables/tHjb/c_tH_m.pdf}
    }
  \end{center}
...
\begin{figure}[htbp]
  \centering
  	\subfloat[Higgs candidate $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/pt_H.png}}
	\subfloat[Higgs candidate $\eta$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/eta_H.png}} 
...
\begin{figure}[htbp]
  \centering
  	\subfloat[Top 1 $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/t1_pt.png}}
	\subfloat[Top 1 $\eta$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/t1_eta.png}} \\
	\subfloat[Top 1 $\phi$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/t1_phi0.png}} 
	\subfloat[Top 1 Reco BDT score]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/t1_score.png}} 
...
\begin{figure}[htbp]
  \centering
  	\subfloat[Hybrid top 2 $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/hy_pt.png}}
	\subfloat[Hybrid top 2 $\eta$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/hy_eta.png}} \\
	\subfloat[Hybrid top 2 $\phi$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/hy_phi0.png}} 
	\subfloat[Hybrid top 2 Reco BDT score]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/t2_score.png}} 
...
\begin{figure}[htbp]
  \centering
  	\subfloat[$\Delta\eta_{t1t2}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/delta_eta_t1hy.png}}
	\subfloat[$\Delta\phi_{t1t2}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/delta_phi_t1hy.png}} 
...
\begin{figure}[htbp]
  \centering
  	\subfloat[$m_{t1H}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/m_t1H.png}}
	\subfloat[$m_{t1hy}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/m_t1hy.png}}
...
\begin{figure}[htbp]
  \centering
  	\subfloat[$n_\text{jets}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/m_njet.png}}
	\subfloat[$n_\text{b-jets}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/m_nbjet_fixed80.png}} \\
	\subfloat[$H_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/m_HT.png}}
	\subfloat[Missing $E_{T}$ significance]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/m_met_sig.png}}
...
\begin{figure}[htbp]
  \centering
  	\subfloat[$\Delta R_{min}^{\gamma j}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/delta_Rmin_yj.png}}
  	\subfloat[$\Delta R_{min}^{\gamma j2}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/lep-vbls/delta_Rmin_yj2.png}}
...
\begin{figure}[htbp]
  \centering
  	\subfloat[Higgs candidate $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/pt_H.png}}
	\subfloat[Higgs candidate $\eta$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/eta_H.png}} 
...
\begin{figure}[htbp]
  \centering
  	\subfloat[Top 1 $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/t1_pt.png}}
	\subfloat[Top 1 $\eta$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/t1_eta.png}} \\
	\subfloat[Top 1 $\phi$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/t1_phi0.png}} 
	\subfloat[Top 1 Reco BDT score]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/t1_score.png}} 
...
\begin{figure}[htbp]
  \centering
  	\subfloat[Hybrid top 2 $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/hy_pt.png}}
	\subfloat[Hybrid top 2 $\eta$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/hy_eta.png}} \\
	\subfloat[Hybrid top 2 $\phi$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/hy_phi0.png}} 
	\subfloat[Hybrid top 2 Reco BDT score]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/t2_score.png}} 
...
\begin{figure}[htbp]
  \centering
  	\subfloat[$\Delta\eta_{t1hy}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/delta_eta_t1hy.png}}
	\subfloat[$\Delta\phi_{t1hy}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/delta_phi_t1hy.png}} 
...
\begin{figure}[htbp]
  \centering
  	\subfloat[$m_{t1H}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/m_t1H.png}}
	\subfloat[$m_{t1hy}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/m_t1hy.png}}
...
\begin{figure}[htbp]
  \centering
  	\subfloat[$n_\text{jets}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/m_njet.png}}
	\subfloat[$n_\text{b-jets}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/m_nbjet_fixed80.png}} \\
	\subfloat[$H_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/m_HT.png}}
	\subfloat[Missing $E_{T}$ significance]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/m_met_sig.png}}
...
\begin{figure}[htbp]
  \centering
  	\subfloat[$\Delta R_{min}^{\gamma j}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/delta_Rmin_yj.png}}
  	\subfloat[$\Delta R_{min}^{\gamma j2}$]{\includegraphics[width=0.32\textwidth]{figures/categorization_xgb/had-vbls/delta_Rmin_yj2.png}}
...
\begin{figure}[htbp]
  \centering
  	\subfloat{\includegraphics[width=0.45\textwidth]{figures/categorization_xgb/had-vbls/BDTG_cp.png}}
...
\begin{figure}[htbp]
  \centering
  	\subfloat{\includegraphics[width=0.45\textwidth]{figures/categorization_xgb/lep-vbls/BDTG_cp.png}}
...
\begin{figure}[htbp]
 \centering
  	\includegraphics[width=0.6\textwidth]{figures/categorization_xgb/BDTdist_had_zero.png}
...
\begin{figure}[htbp]
 \centering
  	\includegraphics[width=0.6\textwidth]{figures/categorization_xgb/BDTdist_lep_zero.png}
...
\begin{figure}[htbp]
 \centering
        \subfloat[Hadronic]{\includegraphics[width=0.42\textwidth]{figures/categorization_xgb/had/Zcomp_had.png}}
        \subfloat[Leptonic]{\includegraphics[width=0.42\textwidth]{figures/categorization_xgb/lep/Zcomp_lep.png}}
...
\begin{figure}[htbp]
 \centering
        \subfloat[Event yield (CP even $ttH$)]{\includegraphics[width=0.42\textwidth]{figures/categorization_xgb/cp_11p8_a0.png}}
        \subfloat[Purity (CP event $ttH$)]{\includegraphics[width=0.42\textwidth]{figures/categorization_xgb/cp_11p8_purity_a0.png}} \\
        \subfloat[Event yield (CP odd $ttH$)]{\includegraphics[width=0.42\textwidth]{figures/categorization_xgb/cp_11p8_a90.png}}
        \subfloat[Purity (CP odd $ttH$)]{\includegraphics[width=0.42\textwidth]{figures/categorization_xgb/cp_11p8_purity_a90.png}}
...
\begin{figure}
  \centering
        \includegraphics[width=0.62\textwidth]{figures/categorization_xgb/cp_11_syst.png}
