...
\begin{figure}
	...
	\caption{Distributions of training variables for the hadronic background-rejection BDT, trained at $79.8 fb^{-1}$. Taken from \cite{HIGG-2018-13}. }
...
\begin{figure}
	...
	\caption{Distributions of training variables for the leptonic background-rejection BDT, trained at $79.8 fb^{-1}$. Taken from \cite{HIGG-2018-13}.}
...
\begin{figure}[htbp]
 \centering
  ...
  \caption{(Left) Event yields in the CP categories at 139 fb$^{-1}$. Shown separately for $\alpha = 0^{\circ}$ and $\alpha = 90^{\circ}$. (Right) purity of the Higgs yield in each category for $\alpha = 0^{\circ}$ and $\alpha = 90^{\circ}$. Yields are calculated in the signal window $m_{\gamma\gamma}=125\pm2$ GeV.}
  \label{fig:nominalb}
\end{figure}
