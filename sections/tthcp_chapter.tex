...
These variables are shown in Figures \ref{fig:ttH_truth1} - \ref{fig:tHjb_truth}.
...
\begin{figure}[!ht] 
  ...
  \end{center}
  \caption{Truth-level distributions in $t\bar{t}H$ Monte Carlo of the Higgs boson $p_{T}$ and $\eta$ (top row) and angular separation between top and anti-top quarks (bottom row) for different values of the CP mixing angle $\alpha$.}
  \label{fig:ttH_truth1}
\end{figure}
...
\begin{figure}[!ht] 
  ...
  \end{center}
  \caption{Truth-level distributions in $t\bar{t}H$ Monte Carlo of the top quark $p_{T}$ and $\eta$ (top row) and invariant mass of the top-Higgs system (bottom row) for different values of the CP mixing angle $\alpha$.}
  \label{fig:ttH_truth2}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat[Signed $\Delta\phi(t,\bar{t})$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/observables/ttH/c_delta_phi_tt_signed.png}}\\
	\subfloat[Signed $\Delta\phi(t,W)$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/observables/ttH/c_delta_phi_tW_signed.png}} 
	\subfloat[Signed $\Delta\phi(t,W)$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/observables/ttH/c_delta_phi_tj_signed.png}} 
...
\begin{figure}[htbp]
  \centering
  	\subfloat[Higgs candidate $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/pt_H.png}}
	\subfloat[Higgs candidate $\eta$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/eta_H.png}} 
  \caption{Leptonic BDT training variables. The open squares represent data in the NTI sideband region, which approximates the shape of the continuum background. }
  \label{fig:lepvbls1}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat[Top 1 $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/t1_pt.png}}
	\subfloat[Top 1 $\eta$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/t1_eta.png}} \\
	\subfloat[Top 1 $\phi$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/t1_phi0.png}} 
	\subfloat[Top 1 Reco BDT score]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/t1_score.png}} 
  \caption{Leptonic BDT training variables. The top $\phi$ is calculated with respect to the Higgs candidate.  The open squares represent data in the NTI sideband region, which approximates the shape of the continuum background. }
  \label{fig:lepvbls2}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Leptonic BDT training variables. The underflow bins represent events where no second (''hybrid'') top is reconstructed. The open squares indicare data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:lepvbls4}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat[$m_{t1H}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/m_t1H.png}}
	\subfloat[$m_{t1hy}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/m_t1hy.png}}
...
\begin{figure}[htbp]
  \centering
  	\subfloat[$n_\text{jets}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/m_njet.png}}
	\subfloat[$n_\text{b-jets}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/m_nbjet_fixed80.png}} \\
	\subfloat[$H_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/m_HT.png}}
	\subfloat[Missing $E_{T}$ significance]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/m_met_sig.png}}
  \caption{Leptonic BDT training variables jet multiplicity, b-jet multiplicity, $H_{T}$, and missing $E_{T}$ significance.  The open squares show data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:lepvbls6}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat[$\Delta R_{min}^{\gamma j}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/delta_Rmin_yj.png}}
  	\subfloat[$\Delta R_{min}^{\gamma j2}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/delta_Rmin_yj2.png}}
  \caption{Leptonic BDT training variables $\Delta R_{min}^{\gamma j}$ and $\Delta R_{min}^{\gamma j2}$.  The open squares show data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:lepvbls7}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  	\subfloat[Higgs candidate $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/pt_H.png}}
	\subfloat[Higgs candidate $\eta$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/eta_H.png}} 
  \caption{Hadronic BDT training variables.  The open squares show data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:hadvbls1}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat[Top 1 $p_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/t1_pt.png}}
	\subfloat[Top 1 $\eta$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/t1_eta.png}} \\
	\subfloat[Top 1 $\phi$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/t1_phi0.png}} 
	\subfloat[Top 1 Reco BDT score]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/t1_score.png}} 
  \caption{Hadronic BDT training variables. The $\phi$ is calculated with respect to the Higgs candidate.  The open squares show data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:hadvbls2}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Hadronic BDT training variables. The $\phi$ is calculated with respect to the Higgs candidate. The underflow bins in $p_{T}$, $\eta$, and $\phi$ represent events where no second (''hybrid'') top is reconstructed. The underflow bin in the Reco BDT score represents events with fewer than 6 jets.  The open squares show data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:hadvbls3}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat[$\Delta\eta_{t1hy}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/delta_eta_t1hy.png}}
	\subfloat[$\Delta\phi_{t1hy}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/delta_phi_t1hy.png}} 
  \caption{Hadronic BDT training variables. The underflow bins represent events where no second (''hybrid'') top is reconstructed. The open squares show data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:hadvbls4}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat[$m_{t1H}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/m_t1H.png}}
	\subfloat[$m_{t1hy}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/m_t1hy.png}}
  \caption{Multi-object invariant masses used as training variables in the hadronic BDT. The underflow bins in $m_{t2H}$ and $m_{t1t2}$ represent events where no second (''hybrid'') top is reconstructed. The open squares show data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:hadvbls5}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat[$n_\text{jets}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/m_njet.png}}
	\subfloat[$n_\text{b-jets}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/m_nbjet_fixed80.png}} \\
	\subfloat[$H_{T}$ (GeV)]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/m_HT.png}}
	\subfloat[Missing $E_{T}$ significance]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/m_met_sig.png}}
  \caption{Hadronic BDT training variables jet multiplicity, b-jet multiplicity, $H_{T}$, and missing $E_{T}$ significance.  The open squares show data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:hadvbls6}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat[$\Delta R_{min}^{\gamma j}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/delta_Rmin_yj.png}}
  	\subfloat[$\Delta R_{min}^{\gamma j2}$]{\includegraphics[width=0.32\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/delta_Rmin_yj2.png}}
  \caption{Hadronic BDT training variables $\Delta R_{min}^{\gamma j}$ and $\Delta R_{min}^{\gamma j2}$.  The open squares show data in the NTI sideband region, which approximates the continuum background shape. }
  \label{fig:hadvbls7}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  	\subfloat{\includegraphics[width=0.45\textwidth]{figures/tthcp_chapter/categorization_xgb/had-vbls/BDTG_cp.png}}
  \caption{Hadronic channel CP BDT score for $ttH$+$tHjb$+$tWH$, with relative weights according to their expected cross sections under various CP mixing scenarios.  The open squares show data in the NTI sideband region. }
  \label{fig:cphad}
\end{figure}

\begin{figure}[htbp]
  \centering
  	\subfloat{\includegraphics[width=0.45\textwidth]{figures/tthcp_chapter/categorization_xgb/lep-vbls/BDTG_cp.png}}
  \caption{Leptonic channel CP BDT score for $ttH$+$tHjb$+$tWH$, with relative weights according to their expected cross sections under various CP mixing scenarios.  The open squares show data in the NTI sideband region. }
  \label{fig:cplep}
\end{figure}
