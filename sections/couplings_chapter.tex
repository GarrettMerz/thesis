...
Signal in each category is modelled using a Double-Sided Crystal Ball function, fit to Higgs-signal Monte Carlo. The fitted Double-Sided Crystal Ball functions in all categories are shown in Appendix \ref{app:couplings_auxplots}. The Higgs mass is fixed to the run-1 measured value of $125.09$ GeV $\pm 0.21 $GeV(stat) $\pm 0.1 $GeV(syst) \cite{Higgsmass}.
